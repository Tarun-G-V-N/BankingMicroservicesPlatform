package com.smartbank.customerservice.constants;
...
public final class CustomerConstants {
    ...
    public static final String MOBILE_UPDATE_SUCCESS_MESSAGE = "Mobile Number updation successful in all services";
    public static final String MOBILE_UPDATE_FAILURE_MESSAGE = "Mobile Number updation failed in all services";
}
